...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.placeholderAttributes = @{NSForegroundColorAttributeName: [UIColor colorWithWhite:1.0 alpha:0.35]};
        
        self.searchField = [[UITextField alloc]initWithFrame:self.bounds];
        ...
        self.searchField.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.2];
        ...
        searchIconImageView.tintColor = [UIColor colorWithWhite:1.0 alpha:0.5];
