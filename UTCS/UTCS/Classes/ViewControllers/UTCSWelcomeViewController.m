...
- (void)viewDidLoad
{
    ...
    self.welcomeTextLabel = ({
        ...
        label.text          = @"The UTCS app is a collaborative project between the Department of Computer Science and MAD, a student organization at the University of Texas at Austin for promoting mobile development.";
        label;
    });
